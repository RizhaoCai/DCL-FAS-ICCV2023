...
# Data config
# ---------------------------------------------------------------------------- #
# data/fair_skin_tone.txt
# data/dark_skin_tone.txt
_C.DATA.TRAIN = ["data/dark_skin_tone.txt"]
_C.DATA.VAL = [""]
_C.DATA.TEST = ["data/fair_skin_tone.txt"]
...
_C.DATA.VAL_BATCH_SIZE = 64
_C.DATA.VAL_NUM_WORKERS = 15
...
_C.TRAIN.INIT = '' # Ckpt to init model
_C.TRAIN.INIT_LR = 1e-4
_C.TRAIN.WEIGHT_DECAY = 0.0
_C.TRAIN.EPOCHS = 20
_C.TRAIN.MOMENTUM = 0.9
_C.TRAIN.LR_PATIENCE = 0
_C.TRAIN.PATIENCE = -1 # -1 means no need to early-step. if > 0, the training will stop if no improvement fro PATIENCE epochs
...
# Optimizer setting
_C.TRAIN.OPTIM = CN(new_allowed=True) # Optimizer
_C.TRAIN.OPTIM.TYPE = 'SGD'
